        ...
        {options.map(option => (
          <TouchableOpacity
            ...
            className={cn(
              ...
              option.value === selectedValue && 'bg-shadcn',
            )}
          >
            <Text
              className={cn(
                option.value === selectedValue
                  ? 'font-semibold text-shadcn-foreground'
                  : 'text-foreground',
              )}
            >
              {option.label}
...
export function DatePicker(props: DatePickerProps) {
  ...
  const calendarData = useMemo(
    () => buildCalendarData(navigation.currentDate),
