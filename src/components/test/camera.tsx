...
function useCameraActions(
  ...
  useEffect(() => {
    ...
    settingsAnim.value = withTiming(s.showSettings ? 1 : 0, { duration: 300 });
          ...
          >
            ...
            {showControls && (
              <>
                ...
                <CameraSideControls enableTorch={enableTorch} facing={facing} torch={torch} toggleTorch={toggleTorch} toggleCameraFacing={toggleCameraFacing} cardColor={cardColor} textColor={textColor} zoomFactorText={zoomFactorText} handleZoomButtonTap={handleZoomButtonTap} enableVideo={enableVideo} mode={mode} isRecording={isRecording} isCapturing={isCapturing} toggleMode={toggleMode} />
